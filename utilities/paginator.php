...
class Paginator{
	...
	*/
	...
	public function page_links($path='?',$ext=null)
	{
		...
		if ($this->_page > 1)
		    $pagination.= "<li><a href='".$path."$this->_instance=$prev"."$ext'>Anterior</a></li>";
		else
		...
		if ($this->_page < $counter - 1)
		    $pagination.= "<li><a href='".$path."$this->_instance=$Siguiente"."$ext'>Siguiente</a></li>";
		else
		    $pagination.= "<li><span class='disabled'>Siguiente</span></li>";
		    $pagination.= "</ul>\n";       
		}
