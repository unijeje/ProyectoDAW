...
<div id="buscador" class="offset-lg-2 col-lg-8 col-12 mb-5">
        ...
        <div class="form-check-inline col-sm-5 offset-0 col-md-3 offset-lg-1 col-lg-3 offset-xl-1 col-xl-3">
        <label class="form-check-label col-12">
            <input type="radio" class="form-check-input" value="juego" name="busqRadio">Juego
        </label>
        </div>
        <div class="form-check-inline col-sm-5 offset-0 col-md-3 offset-lg-0 col-lg-3 offset-xl-0 col-xl-3">
        <label class="form-check-label col-12">
        ...
        <div class="form-check-inline col-sm-5 offset-0 col-md-3 offset-lg-1 offset-lg-1 col-lg-3 offset-xl-1 col-xl-3">
        <label class="form-check-label col-12">
